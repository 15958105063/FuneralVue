...
namespace Funeral.Core.AOP
{
    /// <summary>
    /// 拦截器FuneralLogAOP 继承IInterceptor接口
    /// </summary>
    public class FuneralLogAOP : IInterceptor
    {
        private readonly IHubContext<ChatHub> _hubContext;
        private readonly IHttpContextAccessor _accessor;

        public FuneralLogAOP(IHubContext<ChatHub> hubContext, IHttpContextAccessor accessor)
        {
