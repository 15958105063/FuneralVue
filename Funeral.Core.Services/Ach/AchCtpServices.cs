...
{
    public partial class AchCtpServices : BaseServices<AchCtp>, IAchCtpServices
    {
        private static IHostingEnvironment _environment;
        private readonly IAchCtpRepository _dal;
        public AchCtpServices(IAchCtpRepository dal, IHostingEnvironment iEnvironment)
        {
