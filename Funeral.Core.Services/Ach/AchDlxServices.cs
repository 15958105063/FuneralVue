...
{
    public partial class AchDlxServices : BaseServices<AchDlx>, IAchDlxServices
    {
        private static IHostingEnvironment _environment;
        private readonly IAchDlxRepository _dal;
        public AchDlxServices(IAchDlxRepository dal, IHostingEnvironment iEnvironment)
        {
