...
{
    public partial class AchRsaServices : BaseServices<AchRsa>, IAchRsaServices
    {
        private static IHostingEnvironment _environment;
        private readonly IAchRsaRepository _dal;
        public AchRsaServices(IAchRsaRepository dal, IHostingEnvironment iEnvironment)
        {
