...
{
    public partial class AchCauServices : BaseServices<AchCau>, IAchCauServices
    {
        private static IHostingEnvironment _environment;
        private readonly IAchCauRepository _dal;
        public AchCauServices(IAchCauRepository dal, IHostingEnvironment iEnvironment)
        {
