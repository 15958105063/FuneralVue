...
{
    public partial class AchPvlServices : BaseServices<AchPvl>, IAchPvlServices
    {
        private static IHostingEnvironment _environment;
        private readonly IAchPvlRepository _dal;
        public AchPvlServices(IAchPvlRepository dal, IHostingEnvironment iEnvironment)
        {
