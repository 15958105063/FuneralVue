...
{
    public partial class AchCodServices : BaseServices<AchCod>, IAchCodServices
    {
        private static IHostingEnvironment _environment;
        private readonly IAchCodRepository _dal;
        public AchCodServices(IAchCodRepository dal, IHostingEnvironment iEnvironment)
        {
        ...
        public async Task<string> SaveWordFile(string savePath, string tablename, int tid)
        {
            ...
            try
            {
                string workFileName = checkTime + "部门信息SQL配置脚本";
