...
{
    public partial class AchCaeServices : BaseServices<AchCae>, IAchCaeServices
    {
        private static IHostingEnvironment _environment;
        private readonly IAchCaeRepository _dal;
        public AchCaeServices(IAchCaeRepository dal, IHostingEnvironment iEnvironment)
        {
