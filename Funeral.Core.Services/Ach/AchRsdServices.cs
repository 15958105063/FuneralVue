...
{
    public partial class AchRsdServices : BaseServices<AchRsd>, IAchRsdServices
    {
        private static IHostingEnvironment _environment;
        private readonly IAchRsdRepository _dal;
        public AchRsdServices(IAchRsdRepository dal, IHostingEnvironment iEnvironment)
        {
