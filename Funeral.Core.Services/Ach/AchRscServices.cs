...
{
    public partial class AchRscServices : BaseServices<AchRsc>, IAchRscServices
    {
        private static IHostingEnvironment _environment;
        private readonly IAchRscRepository _dal;
        public AchRscServices(IAchRscRepository dal, IHostingEnvironment iEnvironment)
        {
