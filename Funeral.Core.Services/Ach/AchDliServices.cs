...
{
    public partial class AchDliServices : BaseServices<AchDli>, IAchDliServices
    {
        private static IHostingEnvironment _environment;
        private readonly IAchDliRepository _dal;
        public AchDliServices(IAchDliRepository dal, IHostingEnvironment iEnvironment)
        {
