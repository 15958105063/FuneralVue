...
namespace Funeral.Core.Model.Seed
{
    public class FrameSeed
    {
        ...
        public static bool CreateModels(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            try
            {
                Create_Model_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Funeral.Core.Model", "Funeral.Core.Model.Models", tableNames, "", isMuti);
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateIRepositorys(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            try
            {
                Create_IRepository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Funeral.Core.IRepository", "Funeral.Core.IRepository", tableNames, "", isMuti);
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateIServices(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            try
            {
                Create_IServices_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Funeral.Core.IServices", "Funeral.Core.IServices", tableNames, "", isMuti);
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateRepository(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            try
            {
                Create_Repository_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Funeral.Core.Repository", "Funeral.Core.Repository", tableNames, "", isMuti);
                return true;
            }
            catch (Exception)
            {
        ...
        public static bool CreateServices(SqlSugarClient sqlSugarClient, string ConnId, bool isMuti = false, string[] tableNames = null)
        {
            ...
            try
            {
                Create_Services_ClassFileByDBTalbe(sqlSugarClient, ConnId, $@"C:\my-file\Funeral.Core.Services", "Funeral.Core.Services", tableNames, "", isMuti);
                return true;
            }
            catch (Exception)
            {
...
using Funeral.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public interface I{ClassName}Services :IBaseServices<{ClassName}>" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
	{
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using Funeral.Core.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
    ...
    public class {ClassName}Repository : BaseRepository<{ClassName}>, I{ClassName}Repository" + (string.IsNullOrEmpty(strInterface) ? "" : (" , " + strInterface)) + @"
    {
          ...
          bool isMuti = false)
        {
            ...
            var ls = IDbFirst.IsCreateDefaultValue().IsCreateAttribute()
                  ...
                  .SettingClassTemplate(p => p =
@"using Funeral.Core.IRepository" + (isMuti ? "." + ConnId + "" : "") + @";
using Funeral.Core.IServices" + (isMuti ? "." + ConnId + "" : "") + @";
using Funeral.Core.Model.Models" + (isMuti ? "." + ConnId + "" : "") + @";
